...
class TSApiConfig {
    ...
    //获取群列表接口
    final static String ROBOT_INFO_GetChatRoomList=SERVICE_HOST+"/api/ChatRoom/GetChatRoomList?vcToken={vcToken}?vcToken={TOKEN}"
    ...
    //修改机器人个性签名
    final static String ROBOT_SETTING_ModifyProfileWhatsUp=SERVICE_HOST+"/api/Friend/ModifyProfileWhatsUp?vcToken={TOKEN}"
    //修改机器人昵称
    final static String ROBOT_SETTING_ModifyProfileName=SERVICE_HOST+"/api/Friend/ModifyProfileName?vcToken={TOKEN}"
    //修改机器人头像
    final static String ROBOT_SETTING_ModifyProfileHeadImg=SERVICE_HOST+"/api/Friend/ModifyProfileHeadImg?vcToken={TOKEN}"
    //修改机器人性别
    final static String ROBOT_SETTING_ModifyProfileGender=SERVICE_HOST+"/api/Friend/ModifyProfileGender?vcToken={TOKEN}"
