...
class TSApiConfig {
    final static String merchant_ID = "202003030348392"
    final static String merchant_KEY = "BIJ7KoXX7VAMh8fmkKtIYBNwZriEmKRb"
    final static String[] robotList = ['0AE8CA82E253061F10A63B91AE9577DE', '64000270CCC99BCCDD4F33F95DD37F7F']
    final static int ROBOT_ROOM_LIMIT = 10

    final static String AUTH_HOST = "https://merchant.auth.u-qun.com:8081"  //"http://auth.opsdns.cc:8081"
    final static String SERVICE_HOST = "http://merchant.wapi.tusepaas.com:8081"

    final static String AUTH_TOKEN_URL = AUTH_HOST + "/api/oauth/get_token"
    //merchant  //secret  //token值2个小时后，将会自动失效, 每天获取Token的次数上限为100次
